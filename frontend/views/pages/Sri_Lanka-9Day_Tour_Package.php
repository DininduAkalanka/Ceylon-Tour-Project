            ...
            <div class="modern-gallery-section">
                ...
                <div class="tour-gallery-grid">
                    ...
                    <div class="gallery-main-image" onclick="openGalleryLightbox()">
                        <img src="/assets/image-gallery/Alla1.jpg" alt="Ella Nine Arch Bridge" id="mainGalleryImage">
                    ...
                    <div class="gallery-grid-sidebar">
                        <div class="grid-image" onclick="changeMainImage(this, 'image galary/kandy1.jpg')">
                            <img src="/assets/image-gallery/kandy2.jpg" alt="Temple of Sacred Tooth Relic - Kandy">
                        ...
                        <div class="grid-image" onclick="changeMainImage(this, 'image galary/ella.jpg')">
                            <img src="/assets/image-gallery/yala3.jpg" alt="Yala National Park Safari">
                            <div class="grid-overlay">
                        ...
                        <div class="grid-image" onclick="changeMainImage(this, 'image galary/mirissaBeach.jpg')">
                            <img src="/assets/image-gallery/mirissaBeach.jpg" alt="Mirissa Beach">
                            <div class="grid-overlay">
                        ...
                        <div class="grid-image more-photos" onclick="openGalleryLightbox()">
                            <img src="/assets/image-gallery/yala1.jpg" alt="View More">
                ...
                <div class="lightbox-container">
                    ...
                    <div class="lightbox-main">
                        <div class="main-image-wrapper">
                            <img src="/assets/image-gallery/Alla1.jpg" alt="Ella Nine Arch Bridge" id="lightboxMainImage">
                    ...
                    <div class="lightbox-thumbnails">
                        <div class="thumbnail-item" onclick="selectLightboxImage(2)">
                            <img src="/assets/image-gallery/Alla1.jpg" alt="Ella Nine Arch Bridge">
                        </div>
                        <div class="thumbnail-item active" onclick="selectLightboxImage(0)">
                            <img src="/assets/image-gallery/sigiriya2.jpeg" alt="Sigiriya Rock Fortress">
                        </div>
                        <div class="thumbnail-item" onclick="selectLightboxImage(1)">
                            <img src="/assets/image-gallery/kandy2.jpg" alt="Kandy - Sacred Temple of the Tooth">
                        </div>

                        <div class="thumbnail-item" onclick="selectLightboxImage(3)">
                            <img src="/assets/image-gallery/ancientcity.jpg" alt="Ancient City of Polonnaruwa">
                        </div>
                        ...
                        <div class="thumbnail-item" onclick="selectLightboxImage(6)">
                            <img src="/assets/image-gallery/nuwaraeliya1.jpg" alt="Nuwara Eliya - Little England">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper features-slider">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="/assets/image-gallery/kandyy.jpg" alt="Kandy City Tour">
                        ...
                        <div class="swiper-slide">
                            <div class="feature-showcase-item">
                                <div class="feature-image">
                                    <img src="/assets/image-gallery/Alla1.jpg" alt="Scenic Train Journey">
